...
public class UserDao {
    ...
    public User findByUserId(int uid) {
        ...
        String sql = "SELECT uid,upasswd,uname,uage,uaddr FROM user WHERE uid=?";
...
//        List list = jdbcTemplate.queryForObject(sql, new Object[]{id}, List.class);
    ...
    public User findByName(String uname) {
        ...
        final User user = new User();
        String sql = "SELECT uid,upasswd,uname,uage,uaddr FROM user WHERE uname=?";
    ...
    public User findByNameAndPassword(String name, String password) {
        ...
        final User user = new User();
        String sql = "SELECT uid,uname,uage,uaddr FROM user WHERE uname=? AND upasswd=?";
    ...
    public int insertUser(User user) {
        String sql = "INSERT INTO user (upasswd,uname,uage,uaddr) VALUES (?,?,?)";
